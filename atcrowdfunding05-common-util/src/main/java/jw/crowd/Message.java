...
public class Message {
    public static void main(String[] args) {
        ...
        String appcode = "61f2eaa3c43e42ad82c26fbbe1061311"; // 【3】开通服务后 买家中心-查看AppCode
        String sign = "151003"; // 【4】请求参数，详见文档描述
        String skin = "84683"; // 【4】请求参数，详见文档描述
        String param = "123456"; // 【4】请求参数，详见文档描述
        String phone = "参数名错误 或 其他错误。Api Market Subscription quota exhausted"; // 【4】请求参数，详见文档描述
