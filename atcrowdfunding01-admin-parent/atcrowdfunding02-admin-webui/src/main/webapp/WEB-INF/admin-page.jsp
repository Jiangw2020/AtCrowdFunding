                        ...
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                                <c:if test="${empty requestScope.pageInfo.list }">
                                    <tr>
                                        <td colspan="6" align="center"><span style="color: red">抱歉！没有查询到相关的数据！</span></td>
                                    </tr>
                                </c:if>
                                <c:if test="${!empty requestScope.pageInfo.list }">
                                    <c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="admin/to/edit/page.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageNum }"
